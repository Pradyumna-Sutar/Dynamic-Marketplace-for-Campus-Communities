...
uri = "mongodb+srv://romocromo90:romocromo9@cluster0.atmpzxm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
client = MongoClient(uri)
db = client.Campus_market  # This will use or create the 'Campus_market' database

# Example of creating a collection and inserting a document
db.users.insert_one({'username': 'sample_user', 'password': 'sample_password'})

print("Database and collection created with initial document.")
